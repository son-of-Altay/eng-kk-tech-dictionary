...
| screen                       | экран / скрин        |                                                                                              |
| kernel                       |  Жаңақ/Өзек          |   Нағыз linux ОС емес , нағыз linux |
| mobile                       |  ұтқыр               |    ұтқыр әзірлеуші  |
# Операциялық жүйелер (ОЖ)

| ағылшынша                     | қазақша                              | Мысалы                            |
|-------------------------------|--------------------------------------|-----------------------------------|
| boot                          | қосу                                 | Linux операциялық жүйесін жүктеу. |
| command                       | пәрмен                               |                                   |
| disable                       | сөндіру                              |                                   |
| enable                        | қосу                                 |                                   |
...
| archive        | мұрағат(-тау)  |                                                                                                                          |
| bold           | жуан           |                                                                                                                          |
| compress       | сығу           | "Силикон алқабы" - деп аталатын әзіл-ысқақ сериалында Ричәд атты басты кейіпкер деректерді сығу алгоритмін ойлап табады. |
| copy           | көшіру         |                                                                                                                          |
| cut            | қиып алу       |                                                                                                                          |
| decrypt        | дешифрлау      | Ал мына код құпиясөздерді дешифрлайды.                                                                                   |
| directory      | директори      |                                                                                                                          |
...
| chat         | сөйлек                                                      | сөйлектегі ережелерді сақтаңыз — сұраныс жіберу                                                                                                                |
                                                                                                              |
